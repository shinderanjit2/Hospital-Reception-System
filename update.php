...
<html>
    ...
    <div class="header">
        ...
        <center>
            ...
            <a href="pshow.php"><button>BACK</button></a>
        </center>
...
<?php 
        ...
        $sql="select *from patient where no='$_GET[id]'";
    ...
    if(isset($_POST['submit']))
    {
       ...
       // $no='$_GET[id]';
        ...
        $sql="UPDATE patient SET name ='$n', address='$add', mobile='$mob',age='$a', gender='$g', ward='$w' WHERE no='$_GET[id]'";
