...
<html>
    ...
    <body>
        ...
        <center>
            ...
            <a href="vinfo.php"><button class="btn">ADD VISITOR</button></a>
        <center>
            ...
            <?php
                ...
                if($records->num_rows>0)
                {
                    ...
                    while($row=mysqli_fetch_array($records))
                    {
                        ...
                        echo "<td>".$row['date']."</td>";
                        echo "<td>".$row['time']."</td>";
                        echo "<td><a href=updatev.php?id=".$row['no']."><button class='up'>Update</button></a></td>";
                        echo "<td><a href=deletev.php?id=".$row['no']."><button class='del'>Delete</button></a></td>";
                        echo "</tbody>";
                        $no++;
                    }
